...
<div id="main">
        ...
        <div class="main-wrap">
            ...
            <div class="separator">
                <h4 class="titleBack"><strong>Detalhes do Produto </strong> - <?php echo $nome;  ?></h4>
            ...
            <div class="clear20"></div>
              ...
              <div class="outerOneThird">
                <span class="imageWrap">
                    <img src="<?php echo base_url(); ?>assets/images_dinamic/product/<?php echo $imagem; ?>" alt="<?php echo $nome; ?>">
                </span>
