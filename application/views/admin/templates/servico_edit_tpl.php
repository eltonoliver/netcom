...
foreach ($listService as $value) {
	...
	$idCategory		= $value->serviceCategory_id;

}
$thumb = explode('.', $thumbImagem);
$thumb = $thumb[0]."_thumb.".$thumb[1];
 ?>
<h4 class="titleBack"><center>Editar Serviço</center></h4>
<br />
<span id="erro"><?php echo validation_errors();  ?></span>
<span id="msg"><?php echo $this->session->flashdata('msg');?></span>
<?php  echo form_open_multipart('admin/servico/updateService/'.$id);   ?>

Nome do Produto :  <input type="text" name="nameProduct"	placeholder="Alterar o nome do serviço" class="inputSize" value="<?php echo $nome ?>"/> <br />
Título do Produto :  <input type="text" name="titleProduct"	placeholder="Alterar o título do serviço" class="inputSize" value="<?php echo $titulo; ?>"/><br />
Imagem do Produto : <input type="file" name="userfile" id="userfile"><br />
Imagem cadastrada : <img src="<?php echo base_url(); ?>assets/images_dinamic/service/<?php echo $thumb; ?>" width="60px;" /><br/>
